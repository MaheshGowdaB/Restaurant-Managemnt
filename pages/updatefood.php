...
if(isset($_POST['sub'])){
   ...
   $price = $_POST['price'];
    $sl = "update food set Foodname='$food',price=$price,category='$category' where Foodname='$foodname'";
    if(mysqli_query($conn,$sl)){
      echo "<script>alert('Food update sucessfully');</script>";
  ...
  $sl = "select * from food where Foodname='$foodname'";
             ...
             <ul class="navbar-nav">
               ...
               <li class="nav-item dropdown">
                 ...
                 <div class="dropdown-menu text-center text-lg-left" aria-labelledby="navbarDropdown">
                   ...
                   <a class="dropdown-item" href="edit-menu.php">Edit</a>
                   <a class="dropdown-item" href="view-menu.php">View</a>
                 </div>
               </li>
               <li class="nav-item">
               ...
               <a href="index.php" style="margin: 6px 6px; font-weight:bolder;" type="submit" class="btn btn-primary">back</a>
             </ul>
          ...
          <div class="form-row">
            <div class="form-group col-md-3">
              <div class="row" style="margin-top: 6px;">
                ...
                <div class="col-sm-9" >
                  <input type="text" class="form-control" id="inputName" placeholder="Abc" value="<?php echo $rs['Foodname'];?>" name="foodname" >
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-9">
              <input type="number" class="form-control"placeholder="0" name="price" value="<?php echo $rs['price'];?>">
