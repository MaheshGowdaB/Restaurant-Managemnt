      ...
      <center><h2>MENU</h2></center>
        <table>
            ...
            <tr>
              ...
              <td>Rs.<?php echo $rs['price'] ?> /-</td>
              <td><a href="updatefood.php?foodname=<?php echo $rs['Foodname'] ?>">Edit</a></td>
              <td><a href="deletefood.php?foodname=<?php echo $rs['Foodname'] ?>">Delete</a></td>
            </tr>
            <?php } ?>
          </table>
