      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div class="collapse navbar-collapse text-center" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="pages/album.php">Album</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="pages/reservations.php">Reservations</a>
            </li>
            <li class="nav-item">
        ...
        <div class="carousel-inner">
          <div class="dark-overlay carousel-item active">
            ...
            <div class="carousel-caption">
              ...
              <a class="mt-3 btn btn-light" href="pages/reservations.php" role="button">BOOK NOW</a>
            </div>
          </div>
